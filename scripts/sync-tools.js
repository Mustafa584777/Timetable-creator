...
studentHtml = studentHtml.replace(/<link rel="alternate" hreflang="x-default" href="https:\/\/timetablecreator\.online\/" \/>/g, '<link rel="alternate" hreflang="x-default" href="https://timetablecreator.online/timetable-generator-online-for-students/" />');
studentHtml = studentHtml.replace(/<link rel="alternate" hreflang="en" href="https:\/\/timetablecreator\.online\/" \/>/g, '<link rel="alternate" hreflang="en" href="https://timetablecreator.online/timetable-generator-online-for-students/" />');
studentHtml = studentHtml.replace(/<link rel="alternate" hreflang="es" href="https:\/\/timetablecreator\.online\/\?lang=es" \/>/g, '<link rel="alternate" hreflang="es" href="https://timetablecreator.online/timetable-generator-online-for-students/?lang=es" />');
studentHtml = studentHtml.replace(/<link rel="alternate" hreflang="fr" href="https:\/\/timetablecreator\.online\/\?lang=fr" \/>/g, '<link rel="alternate" hreflang="fr" href="https://timetablecreator.online/timetable-generator-online-for-students/?lang=fr" />');
studentHtml = studentHtml.replace(/<link rel="alternate" hreflang="de" href="https:\/\/timetablecreator\.online\/\?lang=de" \/>/g, '<link rel="alternate" hreflang="de" href="https://timetablecreator.online/timetable-generator-online-for-students/?lang=de" />');
studentHtml = studentHtml.replace(/<link rel="alternate" hreflang="ru" href="https:\/\/timetablecreator\.online\/\?lang=ru" \/>/g, '<link rel="alternate" hreflang="ru" href="https://timetablecreator.online/timetable-generator-online-for-students/?lang=ru" />');
studentHtml = studentHtml.replace(/<link rel="alternate" hreflang="ar" href="https:\/\/timetablecreator\.online\/\?lang=ar" \/>/g, '<link rel="alternate" hreflang="ar" href="https://timetablecreator.online/timetable-generator-online-for-students/?lang=ar" />');
studentHtml = studentHtml.replace(/<link rel="alternate" hreflang="hi" href="https:\/\/timetablecreator\.online\/\?lang=hi" \/>/g, '<link rel="alternate" hreflang="hi" href="https://timetablecreator.online/timetable-generator-online-for-students/?lang=hi" />');
studentHtml = studentHtml.replace(/<link rel="alternate" hreflang="zh" href="https:\/\/timetablecreator\.online\/\?lang=zh-CN" \/>/g, '<link rel="alternate" hreflang="zh" href="https://timetablecreator.online/timetable-generator-online-for-students/?lang=zh-CN" />');
studentHtml = studentHtml.replace(/<link rel="alternate" hreflang="zh-Hans" href="https:\/\/timetablecreator\.online\/\?lang=zh-CN" \/>/g, '<link rel="alternate" hreflang="zh-Hans" href="https://timetablecreator.online/timetable-generator-online-for-students/?lang=zh-CN" />');
...
genHtml = genHtml.replace(/<link rel="alternate" hreflang="x-default" href="https:\/\/timetablecreator\.online\/" \/>/g, '<link rel="alternate" hreflang="x-default" href="https://timetablecreator.online/timetable-generator/" />');
genHtml = genHtml.replace(/<link rel="alternate" hreflang="en" href="https:\/\/timetablecreator\.online\/" \/>/g, '<link rel="alternate" hreflang="en" href="https://timetablecreator.online/timetable-generator/" />');
genHtml = genHtml.replace(/<link rel="alternate" hreflang="es" href="https:\/\/timetablecreator\.online\/\?lang=es" \/>/g, '<link rel="alternate" hreflang="es" href="https://timetablecreator.online/timetable-generator/?lang=es" />');
genHtml = genHtml.replace(/<link rel="alternate" hreflang="fr" href="https:\/\/timetablecreator\.online\/\?lang=fr" \/>/g, '<link rel="alternate" hreflang="fr" href="https://timetablecreator.online/timetable-generator/?lang=fr" />');
genHtml = genHtml.replace(/<link rel="alternate" hreflang="de" href="https:\/\/timetablecreator\.online\/\?lang=de" \/>/g, '<link rel="alternate" hreflang="de" href="https://timetablecreator.online/timetable-generator/?lang=de" />');
genHtml = genHtml.replace(/<link rel="alternate" hreflang="ru" href="https:\/\/timetablecreator\.online\/\?lang=ru" \/>/g, '<link rel="alternate" hreflang="ru" href="https://timetablecreator.online/timetable-generator/?lang=ru" />');
genHtml = genHtml.replace(/<link rel="alternate" hreflang="ar" href="https:\/\/timetablecreator\.online\/\?lang=ar" \/>/g, '<link rel="alternate" hreflang="ar" href="https://timetablecreator.online/timetable-generator/?lang=ar" />');
genHtml = genHtml.replace(/<link rel="alternate" hreflang="hi" href="https:\/\/timetablecreator\.online\/\?lang=hi" \/>/g, '<link rel="alternate" hreflang="hi" href="https://timetablecreator.online/timetable-generator/?lang=hi" />');
genHtml = genHtml.replace(/<link rel="alternate" hreflang="zh" href="https:\/\/timetablecreator\.online\/\?lang=zh-CN" \/>/g, '<link rel="alternate" hreflang="zh" href="https://timetablecreator.online/timetable-generator/?lang=zh-CN" />');
genHtml = genHtml.replace(/<link rel="alternate" hreflang="zh-Hans" href="https:\/\/timetablecreator\.online\/\?lang=zh-CN" \/>/g, '<link rel="alternate" hreflang="zh-Hans" href="https://timetablecreator.online/timetable-generator/?lang=zh-CN" />');
